<template>
  ...
  >
    ...
    <div class="space-y-2">
      <div class="relative">
        ...
        <div
          class="absolute left-1/2 top-1/2 -ml-2 -mt-2 flex h-4 w-4 items-center justify-center rounded-full bg-white shadow ring-2 ring-cyan-500 dark:ring-cyan-400"
        >
          <div
            class="h-1.5 w-1.5 rounded-full bg-cyan-500 ring-1 ring-inset ring-slate-900/5 dark:bg-cyan-400"
          ></div>
        </div>
      </div>
  ...
  >
    ...
    <div class="flex flex-auto items-center justify-evenly">
      ...
      <button
        type="button"
        class="rounded-lg px-2 text-xs font-semibold leading-6 text-slate-500 ring-2 ring-inset ring-slate-500 dark:bg-slate-500 dark:text-slate-100 dark:ring-0"
      >
        1x
      </button>
    </div>
