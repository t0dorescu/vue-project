<template>
  <div class="flex font-serif shadow-md rounded-md mt-10 border-gray-200 border">
    <div class="flex-none w-52 relative">
      <img
        src="https://tailwindcss.com/_next/static/media/fancy-suit-jacket.edfeb695.jpg"
        alt=""
